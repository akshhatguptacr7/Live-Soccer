...
(async function init() {
    ...
    function renderTicker(live) {
        ...
        ticker.innerHTML = live
            .map(function (m) {
                ...
                const homeGoals = m.goals && (m.goals.home !== null) ? m.goals.home : '';
                const awayGoals = m.goals && (m.goals.away !== null) ? m.goals.away : '';
                return (
    ...
    async function refreshUI() {
        ...
        var live = resp.filter(function (m) {
            var s1 = (m.fixture && m.fixture.status && m.fixture.status.short) || '';
            var s2 = (m.fixture && m.fixture.status && m.fixture.status.long) || '';
            return (s1.toLowerCase() === 'live') || (s2.toLowerCase().indexOf('live') !== -1);
        });

        var upcoming = resp.filter(function (m) {
